...
class ValueGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "name", "domain", "subject", "covariates", "properties"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ValueGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ValueGroup from a dict"""
        if obj is None:
            return None
