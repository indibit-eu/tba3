...
class CompetenceLevelsInner(BaseModel):
    """
    CompetenceLevelsInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = Field(default=None, description="Art der Wertegruppe, z.B. `group`, `student`, `school`")
    ...
    competence_levels: List[CompetenceLevelStatisticsInner] = Field(description="Kompetenzstufenverteilung in der Wertegruppe", alias="competenceLevels")
    __properties: ClassVar[List[str]] = ["id", "type", "name", "domain", "subject", "covariates", "properties", "competenceLevels"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CompetenceLevelsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CompetenceLevelsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "competenceLevels": [CompetenceLevelStatisticsInner.from_dict(_item) for _item in obj.get("competenceLevels")] if obj.get("competenceLevels") is not None else None
        })
        return _obj
