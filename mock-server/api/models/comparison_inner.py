...
class ComparisonInner(BaseModel):
    """
    ComparisonInner
    """ # noqa: E501
    ...
    descriptive_statistics: DescriptiveStatistics = Field(alias="descriptiveStatistics")
    __properties: ClassVar[List[str]] = ["id", "name", "domain", "covariates", "attributes", "descriptiveStatistics"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ComparisonInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ComparisonInner from a dict"""
        if obj is None:
            return None
