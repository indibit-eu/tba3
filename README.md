...
![](docs/api-aufbau.png)
![](docs/response-lösungshaufigkeit-item.png)
![](docs/response-teilnehmende.png)

## Nutzungsbeispiele

![](docs/lerngruppen-items.png)
![](docs/laender-items.png)
![](docs/lerngruppen-merkmale.png)
![](docs/lerngruppen-mittelwert.png)
![](docs/lerngruppen-kompetenzstufen.png)
![](docs/laender-kompetenzstufen.png)
